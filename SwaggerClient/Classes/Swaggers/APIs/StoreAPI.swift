...
open class StoreAPI {
     ...
     */
    open class func deleteOrderWithRequestBuilder(orderId: Int64) -> RequestBuilder<Void> {
  ...
  "key" : 0
    ...
    open class func getInventoryWithRequestBuilder() -> RequestBuilder<[String:Int]> {
        ...
        let requestBuilder: RequestBuilder<[String:Int]>.Type = SwaggerClientAPI.requestBuilderFactory.getBuilder()
